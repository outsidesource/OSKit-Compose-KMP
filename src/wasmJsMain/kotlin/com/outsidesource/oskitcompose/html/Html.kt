 ...
 *   functions for dispatching and listening to events. Note: If your compose viewport is not document.body, you will
 *   need to specify the compose viewport element. This is required to proxy all touch and key events to the primary
 *   canvas generated by compose.
 ...
 *   Any dynamic changes will need to be done via JavaScript.
 */
 ...
 */
@Composable
fun rememberHtmlState(composeViewport: Element = document.body!!): HtmlState = remember(composeViewport) {
    HtmlState(composeViewport = composeViewport)
}

/**
 * @param composeViewport The element containing the primary compose viewport. Defaults to document.body.
